...
class WeightViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.title = "Ideal Weight Calculator".localizableString()
        ...
        if( heightTextField.text == "" || ageTextField.text == "")
        {
            ...
            if let height: Double = Double(heightTextField.text ?? ""),
                ...
                if(height < 0 || age < 0 ){
                    ...
                    resultLabel.text =  "Men:".localizableString() + " \(String(format:"%.2f", resultMen)) "
...
extension WeightViewController {
    ...
    func setupLocalization(){
        self.heightTextField.placeholder = "Height (in cms)".localizableString()
        self.ageTextField.placeholder = "Age".localizableString()
        
        self.calaculateWeigthtButton.setTitle("calculate".localizableString(), for: .normal)
    }
